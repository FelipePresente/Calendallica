...
import { createGoal } from "../../../services/goalsService.ts"
...
export default function AddGoal({ onClose }: AddGoalProps) {
        ...
        >
            <div className="bg-zinc-900 border border-zinc-800 w-full max-w-sm rounded-2xl shadow-2xl p-10 relative overflow-hidden">
                <div className="flex justify-between items-start mb-10">
                    <div>
                        <h2 className="text-3xl font-black text-white tracking-tight">New Goal</h2>
                ...
                <form id="addGoalForm" onSubmit={handleSubmit} className="space-y-8">

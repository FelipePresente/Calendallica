            ...
            <details open
                ...
                <summary
                    ...
                    <div>
                        ...
                        <p className="text-xs text-zinc-500 font-medium uppercase mt-1">No goals
                            defined</p>
                    </div>
                    <div
                ...
                <div className="list-type p-5 space-y-4 overflow-y-auto max-h-[600px] bg-zinc-900/40"></div>
